...
<template>
  <div class="flex items-center">
    ...
    <!-- Campo de Entrada para Cidade com Ícone de Busca -->
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-3">
        ...
        >
          ...
          >
            <path
              fill-rule="evenodd"
              d="M13.707 12.293a8 8 0 111.414-1.414l4.586 4.586a1 1 0 01-1.414 1.414l-4.586-4.586zM12 8a6 6 0 1112 12 6 6 0 01-12-12z"
              clip-rule="evenodd"
            />
          </svg>
        </button>
...
export default {
  ...
  methods: {
    ...mapActions(["fetchDataDodosCidade", "fetchDadosTempo"]),
    search() {
      if (this.selectedState === "") {
        ...
        this.fetchDataDodosCidade({
          cidade: this.city,
          uf: this.selectedState,
        }).then(() => {
          // Chamando a função para pegar a previsão do tempo após buscar dados da cidade
          if (this.dadosCidade) {
            this.fetchDadosTempo({
